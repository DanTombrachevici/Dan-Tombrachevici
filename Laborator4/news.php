...
<body>
    <section class="bg">
    <h1 class="text_title">News</h1>
    <p style="font-family:monospace;font-size: 30px;margin-left: 1%;"><a href="https://www.tesla.com/"style="color: black; text-decoration:none ; position:fixed;">Tesla</a></p>
    <br>
    <h2 style="font-family:monospace;font-size: 28px;margin-left: 7%">Back To The Office: Excellence & Respect</h2>
    <p style="font-family:monospace;font-size: 13px;margin-left: 7%"> July 21,2021 </p>
    <br>
    <div class="text_news">
        <p>*Sharing this recent note to employees from Valerie Capers Workman, VP People:</p><br>
        <p>Hi Team,</p><br>
        <p>This month we are in the process of welcoming employees back to Tesla offices. Whether you’ve been working on site or working remotely, we want to thank you for your hard work as Tesla continues to break records and achieve new milestones virtually every day. We are returning to a new normal, but the basic principles that guide Tesla’s success remain the same: excellence and respect.</p>
